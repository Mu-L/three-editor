<template>
    ...
    <div v-show="isShow">
        <div class="info">
            <div><el-link class="textc" @click="openUrl('community')">- 开源 3D 案例社区🍀</el-link></div>
            <div class="link">
        ...
        <div class="pay">
            <div style="margin-bottom: 5px;"><el-link class="text" style="font-size: 14px;" @click="openLink('https://z2586300277.github.io/threejs-editor-beta/')">🍎 新编辑器 (测试版) -</el-link></div>
            <div style="margin-bottom: 5px;"><el-link class="text" style="font-size: 14px;" @click="openLink('https://www.goofish.com/personal?userId=2885508577')">🐟 定制开发 -</el-link></div>
